...
public class journalEntryController {
    ...
    public ResponseEntity<?> deleteJournalEntryById(@PathVariable ObjectId myId,@PathVariable String userName){ // Wild Card Koi aur class ka imstance bhi retun kara sakte hai
